...
import {Navbar,Nav,Form,FormControl,Button,Container,ListGroup, NavDropdown} from "react-bootstrap";
  ...
  return (
    <>
      <Navbar className="fixed-top navbar-dark bg-dark" expand="lg" expanded={isExpanded}>
        <Container>
          <Navbar.Brand onClick={handleBrandClick}>Kanwar Preet Kaur</Navbar.Brand>
